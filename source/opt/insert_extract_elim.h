...
class InsertExtractElimPass : public MemPass {
 ...
 private:
  ...
  // Mark all inserts in chain ending at |ins| that intersect with
  // |extIndices| starting with index at |extOffset|. Chains are composed
  // solely of Inserts and Phis. Mark all inserts in chain if |ext| is nullptr.
