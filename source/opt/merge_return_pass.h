 ...
 * been exited, it will be at the merge of the dummy switch, with will simply* return.
 *
 ...
 * the loop merge. That merge is predicated such that the old body of the block is
