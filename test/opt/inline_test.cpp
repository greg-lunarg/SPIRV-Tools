...
"%_ptr_UniformConstant_27 = OpTypePointer UniformConstant %27",
    ...
    "%v2float = OpTypeVector %float 2",
         "%31 = OpConstant %float 1",
         "%32 = OpConstantComposite %v2float %31 %31",
"%_ptr_Input_v4float = OpTypePointer Input %v4float",
  "%BaseColor = OpVariable %_ptr_Input_v4float Input",
         "%34 = OpConstant %float 0.5",
         "%35 = OpConstantComposite %v2float %34 %34",
"%_ptr_Output_v4float = OpTypePointer Output %v4float",
  "%FragColor = OpVariable %_ptr_Output_v4float Output",
         "%37 = OpConstant %float 3",
       "%main = OpFunction %void None %15",
         "%38 = OpLabel",
     ...
     "%color3 = OpVariable %_ptr_Function_v4float Function",
         ...
         "%43 = OpLoad %v4float %BaseColor",
               "OpStore %param %43",
         "%68 = OpAccessChain %_ptr_Function_float %param %22",
         "%69 = OpLoad %float %68",
               "OpStore %66 %69",
         "%70 = OpLoad %float %66",
         "%71 = OpFOrdLessThan %bool %70 %23",
         ...
         "%54 = OpCompositeConstruct %v4float %37 %37 %37 %37",
   ...
   "%foo_vf4_ = OpFunction %float None %19",
        "%bar = OpFunctionParameter %_ptr_Function_v4float",
         "%56 = OpLabel",
          "%r = OpVariable %_ptr_Function_float Function",
         "%57 = OpAccessChain %_ptr_Function_float %bar %22",
         "%58 = OpLoad %float %57",
               "OpStore %r %58",
         "%59 = OpLoad %float %r",
         "%60 = OpFOrdLessThan %bool %59 %23",
